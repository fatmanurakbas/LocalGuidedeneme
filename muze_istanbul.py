...
class MuseumIstanbulScreen(Screen):
    ...
    def update_ui(self):
        ...
        # İlk müzeyi atla, diğerlerini ekle
        for müze in self.places[1:]:
            ...
            card.bind(on_release=lambda x, r=müze: self.show_müze_detail_istanbul(r))
            container.add_widget(card)

    def show_müze_detail_istanbul(self, müze):
...
<MuseumIstanbulDetailScreen>:
    name: "müze_istanbul_detail"
    ...
    MDBoxLayout:
        ...
        MDTopAppBar:
            title: "Müzeler          "
            elevation: 5
            left_action_items: [["arrow-left", lambda x: app.go_to('müze_istanbul')]]
            md_bg_color: "#5C6BC0"
            size_hint_y: None
            height: dp(56)
